...
- Default shell Node was v18.20.8; Angular CLI 22 requires Node ≥ v22.22.3.
- All verification commands below use `nvm use 22.22.3` (Node v22.22.3 / npm 10.9.8).
...
| `npm run test:engineering` | **34 passed** (7 files) |
